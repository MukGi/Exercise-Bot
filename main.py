...
from coachV4 import get_bot_response, workout_response_dict  # Import from backend module
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.initUI()
        self.showMaximized()
        self.response_dict = workout_response_dict()  # Initialize response dictionary
    ...
    def initUI(self):
        ...
        self.chat_history.setFixedWidth(700)
